function createGame(player1, hour, player2, group) {
  ...
  <li>
      <div class="info-country">
        <img class="country" src="../static/assets/icon-${player1}.svg" alt=""><span class="name-country">${player1}</span>
      </div>
      <div id="details">
      ...
      <div class="info-country">
        <img class="country" src="../static/assets/icon-${player2}.svg" alt=""><span class="name-country">${player2}</span>
      </div>
  </li>
  `
}
