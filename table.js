...
const franceGames = [fillScoutTable(4, 1), fillScoutTable(2,1), fillScoutTable(0,1)]
allGames(france, franceGames)

const australiaGames = [fillScoutTable(1, 4), fillScoutTable(1,0), fillScoutTable(1,0)]
allGames(australia, australiaGames)

const denmarkGames = [fillScoutTable(0, 0), fillScoutTable(1,2), fillScoutTable(0,1)]
allGames(denmark, denmarkGames)

const tunisiaGames = [fillScoutTable(0, 0), fillScoutTable(0,1), fillScoutTable(1,0)]
...
const switzerlandGames = [fillScoutTable(1,0), fillScoutTable(0,1), fillScoutTable(3,2)]
allGames(switzerland, switzerlandGames)

const cameroonGames = [fillScoutTable(0,1), fillScoutTable(3,3), fillScoutTable(1,0)]
allGames(cameroon, cameroonGames)

const brazilGames = [fillScoutTable(2, 0), fillScoutTable(1,0), fillScoutTable(0,1)]
allGames(brazil, brazilGames)

const serbiaGames = [fillScoutTable(0, 2), fillScoutTable(3,3), fillScoutTable(2,3)]
...
const south_koreaGames = [fillScoutTable(0,0),fillScoutTable(2,3), fillScoutTable(2,1)]
allGames(south_korea, south_koreaGames)

const ghanaGames = [fillScoutTable(2,3), fillScoutTable(3,2), fillScoutTable(0,2)]
allGames(ghana, ghanaGames)

const uruguayGames = [fillScoutTable(0,0), fillScoutTable(0,2), fillScoutTable(2,0)]
allGames(uruguay, uruguayGames)

const portugalGames = [fillScoutTable(3,2), fillScoutTable(2,0), fillScoutTable(1,2)]
